	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 offset-md-3 mt-4">
				...
				<form action="addupdatedProduct" method="post">
					<div class="mb-3">
						 <input
							type="text" hidden="true" class="form-control" name="id"  value="${product.id }"
							placeholder="Enter here" id="exampleInputId"
							aria-describedby="IdHelp"></input>
					</div>
					...
					<div class="mb-3">
						...
						<div class="form-floating">
							<textarea class="form-control" name="discription" placeholder="Leave a comment here"
							  	id="floatingTextarea2" style="height: 100px">${product.discription }</textarea>
					...
					<div class="mb-3">
						<label for="exampleInputImage" class="form-label">ImageName</label> <input
							type="text" class="form-control" name="photo" value="${product.photo }"
